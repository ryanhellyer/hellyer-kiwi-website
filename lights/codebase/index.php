 ...
 * Load files.
 */
require( '/mnt/volume-nyc1-01/wordpress.hellyer.kiwi/tp-link-config.php' );
require( '/codebase/caching-layer.php' );
require( '/codebase/escaping.php' );
require( '/codebase/tp-link-php-library/index.php' );
