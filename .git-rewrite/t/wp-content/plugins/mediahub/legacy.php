...
function mediahub_upgrade_notice() {
	...
	<div class="error">
		...
		<p><?php _e( 'Check out <a href="http://status.demediahub.nl/API">http://status.demediahub.nl/API</a> for more information and to obtain new API credentials.', 'mediahub' ); ?></p>
		<p>
