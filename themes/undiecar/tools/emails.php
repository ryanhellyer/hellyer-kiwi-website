...
/** LEAGUE REQUESTS 
Hi [NAME],
You recently applied to join the Undiecar Championship, but we're totally maxed out on drivers now. If you'd like to sign up on our website though, you will be notified if a space becomes available, and also notified when there are special events on that you may be interested in.
...
/*----- to Indycar drivers -------
SUBJECT: Undiecar Championship (undycar.com) invitation
*/

$message = "Hi  \" + shortened_name + \",
I hope you don't mind the impromptu message, but I saw you sometimes do races in the Indycar series here on iRacing and thought you may be interested in the new Undiecar Championship which is starting in just over a weeks time. The races are on Tuesdays at 21:00 GMT (see below for other time zones), starting in a week and a half on September 5th. 
...
It would be awesome to see you on the track in the Undiecar Championship :)
...
$message = "Hi  \" + shortened_name + \",
I hope you don't mind the impromptu message, but I saw you sometimes do races in the Dallara Dash series here on iRacing and thought you may be interested in the new Undiecar Championship which is starting in just over a weeks time. The races are on Tuesdays at 21:00 GMT (see below for other time zones), starting in a week and a half on September 5th. 
...
I also drive those sometimes and really enjoy them, but I also want to drive faster more powerful cars so I\'ve created a new league called the Undiecar Championship and thought you may be interested in it too. It\'s starting in just over a weeks time. The races are on Tuesdays at 21:00 GMT (see below for other time zones), starting in a week and a half on September 5th. 
...
$message = "Hi \" + shortened_name + \",
You should have received an invite to the Undiecar Championship league on iRacing now. The number of appicants for the league unexpectedly exploded on me today, so I've stopped looking for drivers now.
...
If you would like to chit-chat more easily during races, please join the Undiecar Championship Discord:
...
I'm trying to write up the rules for the new Undiecar Championship starting soon and am keen on some input:
...
MESSAGE:
Hi [NAME],
Are you interested in competing in the Undiecar Championship? The races are on Tuesdays at 21:00 GMT (see below for other time zones), starting in a week and a half on September 5th. 

[b][size=24][url]https://undycar.com/[/url][/size][/b]

The tracks and car are all free, so no need to buy anything. The car is the free Dallara Indycar (as used in the Dallara Dash series) with a fixed setup. Half the tracks are ovals, and half are road courses.

It would be awesome to see on the track in the Undiecar Championship :)
...
MESSAGE:
Hi,
If you want to try out iRacing without costing you a fortune, I'm making a new series called the "Undiecar Championship" for it which only uses their free cars and tracks (still need the US$5/month membership fee, but no need to buy cars or tracks).
...
Assuming the league is successful, we can use it to try to recruit new members for SRC too as I can pimp it via the Undiecar Championship website.
