...
class EncryptedFileManager
{
     ...
     */
    public function listItem(bool $new = false, string $page = '', string $fileContent = ''): string
    {
...
$manager = new EncryptedFileManager();

if (isset($_GET['save'])) {
	header('Content-Type: application/json');
    echo json_encode($manager->handleSaveRequest($_POST));
    exit;
}

if (isset($_GET['delete'])) {
	header('Content-Type: application/json');
    echo json_encode($manager->handleDeleteRequest($_POST));
    exit;
}
