...
<main>
	...
	<p class="box invoice-from">
		...
		<br />
		<em>Total Due:</em>
		<strong class="total-amount"><?php echo esc_html( $data[ '_total_amount' ] ); ?></strong>
	</p>
	...
	<table>
		...
		<tfoot>
			<tr>
				<td></td>
				<td>Total amount</td>
				<td class="total-amount"><?php echo esc_html( $data[ '_total_amount' ] ); ?></td>
			</tr>
		</foot>
		<tbody><?php
...
//print_r( $task );die;
	echo '
			<tr>
				...
				<td>' . esc_html( $task[ 'due_date' ] ) . '</td>
				<td>' . esc_html( $task[ 'amount' ] ) . '</td>
			</tr>';
}
