...
$contacted = $current_signups . $personal_contacted . $indycar_road_drivers . $laguna_seca_dallara_dash_drivers . $promazda_drivers . $phoenix_dallara_dash_drivers . $me . $formula_renault_last_2 . $random_hosted_race_girls . $spa_indycar_drivers . $girls1 . $skip_barber.$skip_barber2.$skip_barber3.$formula_renault2.$indycar2.$indycar3;
