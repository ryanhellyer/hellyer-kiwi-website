...
<section id="results">
	...
	?>" class="other-race" style="background-image: linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3) ), url(<?php echo esc_url( get_template_directory_uri() . '/images/tall4.jpg' ); ?>);">
		<h2>Next Season</h2>
