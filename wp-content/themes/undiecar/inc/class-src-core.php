	...
	*/
	...
	public function register_user( $username, $display_name, $password, $email, $member_info ) {
		...
		if ( ! is_wp_error( $user_id ) ) {
			...
			wp_mail( 'ryanhellyer@gmail.com', 'New Undiecar driver: ' . $display_name, '<a href="' . esc_url( 'https://undiecar.com/member/' . sanitize_title( $display_name ) . '/">' . esc_html( $display_name ) . '</a> has signed up to the Undiecar Championship.' );
