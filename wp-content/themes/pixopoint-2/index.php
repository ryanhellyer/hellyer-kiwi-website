...
<div class="post" id="post-<?php the_ID(); ?>">
	...
	?>
	<h2 class="post_title"><?php if ( !is_page() && !is_single() ) : ?><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>"><?php endif; ?><?php the_title(); ?><?php if ( !is_page() && !is_single() ) : ?></a><?php endif; ?></h2>
<?php
