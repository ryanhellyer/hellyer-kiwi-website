...
{
  public static function _scopedRetrieve($class, $id=null, $apiKey=null, $params=array())
  {      
  ...
  public static function _scopedRetrieveEmpty($class, $apiKey=null)
  {
  ...
  public static function _scopedActive($class, $apiKey=null)
  {
    $instance = new $class($apiKey);
  ...
  public static function _scopedInactive($class, $apiKey=null)
  {
    $instance = new $class($apiKey);
  ...
  public static function _validateCall($method, $params=null, $apiKey=null)
  {
  ...
  public static function _scopedAll($class, $params=null, $apiKey=null)
  {
...
//return ryans_log( print_r( $response, true ) );
    return Pushpress_Util::convertToPushpressObject($response, $apiKey);
  }

  public static function _scopedCreate($class, $params=null, $apiKey=null)
  {
  ...
  public function _scopedSave($class)
  {
  ...
  public function _scopedUpdate($class)
  {
    self::_validateCall('save');
    $requestor = new Pushpress_ApiRequestor($this->_apiKey);
    $params = $this->serializeParameters();
  ...
  public function _scopedDelete($class, $params=null)
  {
