...
Donate link: http://geek.ryanhellyer.net/products/spam-destroyer-pro/
...
= 1.6 alpha (10/9/2013) =
* Upgraded to Spam Destroyer Pro
= 1.5 alpha (8/8/2013) =
* Merged stable and alpha together
* Removed tracking system test code
* Removed statistics code
* Simplified code based to avoid bugs found in previous alphas
= 1.4.5 alpha (24/6/2013) =
