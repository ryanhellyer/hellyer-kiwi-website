<?php
/*
Plugin Name: New Media RSS Feed
Plugin URI: https://geek.hellyer.kiwi/plugins/
Description: New Media RSS Feed
Version: 1.0
Author: Ryan Hellyer
...
/**
 * New Media RSS Feed class.
 *
 * @copyright Copyright (c), Ryan Hellyer
 * @license http://www.gnu.org/licenses/gpl.html GPL
 * @author Ryan Hellyer <ryanhellyer@gmail.com>
 */
class New_Media_RSS_Feed {
	...
	public function add_feed(){
		add_feed( 'new_media', array( $this, 'output_template' ) );
	}
	...
	public function rss_content_type( $content_type, $feed_name ) {
		...
		// Return rss2 feed content type of on new_media feed
		if ( 'new_media' === $feed_name ) {
