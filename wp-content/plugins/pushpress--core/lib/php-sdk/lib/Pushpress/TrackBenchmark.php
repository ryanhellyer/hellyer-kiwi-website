<?php
class Pushpress_Track_Benchmark extends Pushpress_ApiResource
{
    
  public static function classUrl($class=null) {
        return "/v1/tracks/benchmarks";
    }
  ...
  public function results($params=null, $apiKey=null) {
              
        $requestor = new Pushpress_ApiRequestor($this->_apiKey);
        $url = $this->instanceUrl() . '/results';
