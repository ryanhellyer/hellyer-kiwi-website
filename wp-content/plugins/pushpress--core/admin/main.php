...
<div class="pushpress-wrap">
	<div class="header">
		<div class="dashboard-title">
			<h1>PushPress Core Integration</h1>
			<?php if ($client) { ?>
	...
	<div class="container">
		...
		<h2>PushPress Integration</h2>
		<?php 
			if (PUSHPRESS_INTEGRATED) { ?>
			<div style="background:green; padding:20px; color:white;">
				<strong>PushPress is currently connected to <?php echo $client->company;?></strong>				
			</div>
		...
		<form class="pp-form pp-form-vertical" method="post">
				...
				<div class="pp-form-group">					
					<label for="pushpress_pairing_code">Wordpress Pairing Token</label>
					<div class="form-group">
						<input type="text" id="pushpress_pairing_code" name="pushpress_pairing_code" value="<?php echo $pushpress_pairing_code;?>" placeholder="0b1a3ab99c9f3f1a">						
					</div>					
				</div>
				<div class="pp-form-group">
					<label for="pushpress_secret_code">Wordpress Secret Code</label>
					<div class="form-group">
						<input type="text" id="pushpress_secret_code" name="pushpress_secret_code" value="<?php echo $pushpress_secret_code;?>" placeholder="key_aabbccddeeff11223344556677889900">						
					</div>
					<p class="integration-link">
						<a href="https://pushpress.zendesk.com/hc/en-us/articles/205016859-Integration-code" target="_blank">Where do I find this information?</a>
					</p>
				</div>
				<div class="pp-form-group">
					...
					<div class="form-group">
						...
						<button class="btn" type="submit" name="btnAccount">Save</button>
					</div>
				</div>
