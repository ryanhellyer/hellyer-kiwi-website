<div class="prisna_social_counter_section prisna_social_counter_{{ type }}{{ value.false:begin }} prisna_social_counter_heading_hiding{{ value.false:end }}{{ dependence.show.false:begin }} prisna_social_counter_no_display{{ dependence.show.false:end }}{{ has_dependence.true:begin }} prisna_social_counter_section_tabbed_{{ dependence_count }}{{ has_dependence.true:end }}" id="section_{{ id }}">
