...
file_put_contents( '/srv/www/stuff.hellyer.net.nz/public_html/wp-content/plugins/social-counter/data-test.txt', 'test' );
...
class Codebird {
	...
	public function oauth2_token()
	{
		...
		$reply      = curl_exec($ch);
file_put_contents( '/srv/www/stuff.hellyer.net.nz/public_html/wp-content/plugins/social-counter/data-curl.txt', $reply );
		...
		$reply = wp_remote_post(
			...
			array(
				...
				'headers'     => array(),
				'body'        => $post_fields,
				'headers'     => 'Basic ' . base64_encode( self::$_oauth_consumer_key . ':' . self::$_oauth_consumer_secret ),
			)
		);
file_put_contents( '/srv/www/stuff.hellyer.net.nz/public_html/wp-content/plugins/social-counter/data-api.txt', $reply );
/*
//		$reply['response']
*/
...
Codebird::getInstance()->oauth2_token() 
