 ...
 * @since     1.0
 * @license   GPL-3.0-or-later @todo is this correct?
 */
...
class Config {
	 ...
	 *
	 * This constant holds the encryption method used for any encryption tasks.
	 *
	 * @var string
	 */
	...
	public function update_spam_key( $key ): bool {
		return update_option( $this->spam_key_option, $key );
	}
	...
	public function get_stored_plugin_version(): string {
		return get_option( 'spam-destroyer-version' );
	}
	...
	public function update_stored_plugin_version( string $version ): bool {
		return update_option( 'spam-destroyer-version', $version );
	}
